    ...
    public class CameraBasic {  
        ...
        static JLabel label;  
        static bl x=new bl();//全局静态变量，用于控制摄像头的读取  
        /** 
        ...
        public static void main(String[] args) {  
            ...
            camera.open(0);//open函数中的0代表当前计算机中索引为0的摄像头 
            if(!camera.isOpened()){//isOpened函数用来判断摄像头调用是否成功  
                ...
                while(x.getx()!=2){
                	while(x.getx()==0){  
                		...
                		label.setIcon(new ImageIcon(mat2BufferedImage.matToBufferedImage(frame,x)));//转换图像格式并输出  
                		try {  
        ...
        private void initialize(){  
            ...
            btnNewButton.addMouseListener(new MouseAdapter() {  
                ...
                public void mouseClicked(MouseEvent arg0) {  
                    x.cinx(1);//静态变量设置为1，从而按下按钮时会停止摄像头的调用  
                }  
            });  
